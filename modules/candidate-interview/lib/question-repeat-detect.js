...
/**
 * Detect when spoken transcript largely repeats the interview question (cheating signal).
 */
export function detectQuestionRepetition(questionText, answerText) {
  ...
  if (!qNorm || qNorm.length < 12 || !aNorm || aNorm.length < 8) {
    return { repeated: false, overlapRatio: 0, phraseRatio: 0, extraAnswerTokens: 0 };
  }
